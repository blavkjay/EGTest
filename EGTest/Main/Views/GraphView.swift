...
class GraphView: UIView {
    ...
    private let emailButton: UIButton = {
        ...
        button.setAttributedTitle(NSAttributedString(string: "Get rate alerts straight to your email inbox", attributes: [.underlineStyle: NSUnderlineStyle.single.rawValue, .font: UIFont.systemFont(ofSize: 14), .foregroundColor: UIColor.white]), for: .normal)
        return button
    }()
