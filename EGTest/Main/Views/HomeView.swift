...
class HomeView: UIView {
    ...
    private let midMarketButton: UIButton = {
        ...
        button.setAttributedTitle(NSAttributedString(string: "Mid-market exchange rate at 13:38 UTC  ", attributes: [.underlineStyle: NSUnderlineStyle.single.rawValue, .font: UIFont.systemFont(ofSize: 14), .foregroundColor: CustomColor.blue ?? UIColor.blue]), for: .normal)
